...
## Checklist
- [x] Ispezionare schema Supabase esistente per products e product_images senza modificarlo
- [x] Aggiornare elenco prodotti con badge, stati colorati, promo futura, filtro archiviati e azioni Modifica/Elimina/Pausa/Riattiva
- [x] Ricostruire form prodotto in sezioni: informazioni base, prezzo, descrizioni, foto, SEO, disponibilità
- [x] Aggiungere gestione immagini multiple con miniature, riordino e cancellazione tramite product_images
- [x] Aggiungere anteprima prima del salvataggio con Modifica, Pubblica ora e Programma
- [x] Salvare creazione/modifica prodotti e immagini usando Supabase senza chiedere tenant_id
